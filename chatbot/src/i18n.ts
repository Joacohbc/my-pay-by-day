...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'error.data_media_required': 'Data and mediaType are required',
    'error.conversion_unavailable': 'Conversion unavailable',
    'error.text_files_required': 'Text or files are required',
    'error.files_required': 'Files are required',
  ...
  es: {
    ...
    'error.data_media_required': 'Los datos y el mediaType son obligatorios',
    'error.conversion_unavailable': 'Conversión no disponible',
    'error.text_files_required': 'El texto o los archivos son obligatorios',
    'error.files_required': 'Los archivos son obligatorios',
