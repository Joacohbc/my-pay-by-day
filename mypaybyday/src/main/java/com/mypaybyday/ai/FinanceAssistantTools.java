...
public class FinanceAssistantTools {
    ...
    @Tool("Lists all available categories. Use this tool to find a category ID if the user mentions a category name.")
    ...
    public CategoryBalanceDto getCategoryBalance(Long categoryId, String fromDateStr, String toDateStr)
