...
const es = {
  ...
  nodes: {
    ...
    iconLabel: 'Ícono',
    profileSection: 'Tope y ciclo',
    profileHint: 'Opcional. Un nodo con tope y ciclo se comporta como una tarjeta de crédito; cada uno también sirve por separado.',
    limitLabel: 'Monto del tope',
    limitPlaceholder: 'Vacío si no tiene tope',
    limitKindLabel: 'Qué significa el tope',
    limitKindDebt: 'Tope de deuda — hasta dónde puede bajar el saldo',
    limitKindTarget: 'Objetivo de saldo — hasta dónde debe subir el saldo',
    cycleDayLabel: 'Día de cierre',
    settlementDayLabel: 'Día de liquidación',
    cycleDayHint: 'Día del mes, del 1 al 28. Definí ambos o ninguno.',
    remainingAvailable: 'Disponible',
    remainingToTarget: 'Falta para el objetivo',
    limitExceeded: 'Excedido',
    closedCycleBalance: 'Ciclo cerrado',
    openCycleBalance: 'Ciclo abierto',
