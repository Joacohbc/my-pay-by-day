...
const es = {
  ...
  paymentPlans: {
    ...
    generateItems: 'Generar el cronograma de cuotas ahora',
    generateItemsHint: 'Desactivalo para agregar cada cuota manualmente después.',
    ...
    kindInstallmentTitle: 'Cuotas y Suscripciones',
    kindInstallmentDescription: 'Una compra en cuotas o una suscripción recurrente, con cadencia y monto.',
    ...
    scheduleLockedHint: 'El calendario de este plan lo genera el sistema. Solo se puede vincular un evento o borrador y cambiar el estado.',
