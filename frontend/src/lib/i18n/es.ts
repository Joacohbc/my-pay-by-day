...
const es = {
  ...
  chat: {
    ...
    approval: {
      ...
      installmentOf: 'Cuota {{number}} · {{date}}',
      fileCount_one: '{{count}} archivo',
      fileCount_other: '{{count}} archivos',
      eventCount_one: '{{count}} evento',
      eventCount_other: '{{count}} eventos',
      draftCount_one: '{{count}} borrador',
      draftCount_other: '{{count}} borradores',
      rejectAll: 'Rechazar todas ({{count}})',
      pendingCount_one: '{{count}} aprobación pendiente',
      pendingCount_other: '{{count}} aprobaciones pendientes',
      modes: {
        MERGE: 'Actualizar el evento vinculado',
        CREATE_ONLY: 'Crear un evento nuevo',
      },
      tools: {
        updateEvent: 'Actualizar este evento',
        createEventGroup: 'Crear el grupo «{{name}}»',
        createInstallmentPlan: 'Crear el plan en cuotas «{{name}}»',
        createRecurringPlan: 'Crear el plan recurrente «{{name}}»',
        createCustomPlan: 'Crear el plan personalizado «{{name}}»',
        updatePaymentPlan: 'Actualizar el plan «{{planId}}»',
        addToPaymentPlan: 'Agregar al plan «{{planId}}»',
        removeFromPaymentPlan: 'Quitar este registro del plan «{{planId}}»',
        updatePaymentPlanItem: 'Actualizar {{itemId}} del plan «{{planId}}»',
      },
      fields: {
        name: 'Nombre',
        description: 'Descripción',
        type: 'Tipo',
        status: 'Estado',
        itemStatus: 'Estado de la entrada',
        mode: 'Modo',
        date: 'Fecha',
        ...
        tagIds: 'Etiquetas',
        lineItems: 'Movimientos',
        currency: 'Moneda',
        fileIds: 'Archivos adjuntos',
        eventId: 'Evento',
        eventIds: 'Eventos',
        draftId: 'Borrador',
        draftIds: 'Borradores',
        targetEventId: 'Evento destino',
        planId: 'Plan de pago',
        itemId: 'Entrada del plan',
        templateId: 'Plantilla',
        frequency: 'Frecuencia',
        isAutomated: 'Automatizado',
    ...
    error: {
      title: 'El asistente no pudo terminar esta respuesta',
      retry: 'Reintentar',
    },
    question: {
      title: 'Pregunta',
  ...
  events: {
    ...
    mergeMixedCurrencies: 'Estos eventos no están en la misma moneda. Unirlos generaría montos que no pueden cuadrar, así que el servidor lo va a rechazar.',
  ...
  nodes: {
    ...
    currencyHint: 'Definila para las cuentas propias, así no se puede registrar por error un monto en otra moneda. Dejala vacía para comercios y personas, que pueden cobrar en cualquier moneda.',
  ...
  paymentPlans: {
    ...
    subtitle: 'Suscripciones, cuotas y compromisos programados.',
    createTitle: 'Nuevo Plan de Pago',
    editTitle: 'Editar Plan de Pago',
    cancelConfirm: '¿Estás seguro de que deseas cancelar este plan de pago?',
    howItWorksTitle: 'Planes de Pago Flexibles',
    howItWorksDesc: 'Realiza el seguimiento de suscripciones, compras en cuotas y agendas de deuda. Los planes automatizados generan borradores en la fecha de vencimiento.',
    remainingCuotasDebt: 'Deuda Restante en Cuotas',
    filterAll: 'Todos los Planes',
    filterInstallment: 'Cuotas',
    filterRecurring: 'Suscripciones',
    ...
    installmentAmountLabel: 'Monto por Ciclo',
    startDateLabel: 'Fecha de Inicio',
    endDateLabel: 'Fecha de Fin',
    endDateOptionalLabel: 'Fecha de Fin (opcional)',
    firstCuotaDateLabel: 'Fecha de la Primera Cuota',
    cycleAmountLabel: 'Monto por Ciclo',
    endBeforeStart: 'La fecha de fin no puede ser anterior a la de inicio',
    templateLabel: 'Plantilla',
    templateHint: 'La plantilla aporta los nodos de origen y destino de cada evento que genera este plan.',
    ...
    itemWindowOpenHint: 'Este plan empieza el {{from}} y no tiene fecha de fin.',
    isAutomated: 'Ejecución Automatizada (Tareas en Segundo Plano)',
    autoCreateDraft: 'Generar Borrador para confirmación en fecha de vencimiento',
    automated: 'Automatizado',
    manual: 'Manual',
    cycleAmount: 'Monto del Ciclo',
    cuotasLabel: 'Cuotas',
    ...
    addItem: 'Agregar Cuota',
    itemNewTitle: 'Nueva Cuota',
    itemEditTitle: 'Editar Cuota',
    itemNumberLabel: 'Número de Cuota',
    itemDeleteConfirm: '¿Estás seguro de que deseas eliminar esta cuota?',
    linkedRecord: 'Registro Vinculado',
    linkedEvent: 'Evento',
    linkedDraft: 'Borrador',
    switchToManual: 'Cambiar a manual',
    switchToAutomated: 'Cambiar a automático',
    eventSectionTitle: 'Planes de Pago',
    assignEvent: 'Asignar a un plan',
    assignTitle: 'Asignar evento a un plan de pago',
    assignPlanLabel: 'Plan de pago',
    assignItemLabel: 'Cuota',
    assignNewItem: 'Crear una cuota nueva para este evento',
    assignSubmit: 'Asignar',
    assignHint: 'La cuota elegida se marca como pagada y queda vinculada a este evento. Las cuotas ya vinculadas a otro evento no se listan.',
    noAssignments: 'Este evento no está asignado a ningún plan de pago.',
    unassign: 'Desasignar',
    unassignConfirm: '¿Quitar este evento de la cuota? La cuota vuelve a estado pendiente.',
    assignNoFreeItems: 'Este plan no tiene cuotas libres y su calendario lo genera el sistema.',
    assignGroupItemLabel: 'Ítem del grupo',
    ...
    kindInstallmentDescription: 'Una compra dividida en una cantidad conocida de cuotas: cantidad fija, cadencia fija, un cronograma que termina.',
    kindSubscriptionTitle: 'Suscripción',
    kindSubscriptionDescription: 'Un acuerdo recurrente sin fin — alquiler, Netflix. No tiene cantidad de cuotas: cada ciclo se agrega cuando ocurre.',
    kindCustomTitle: 'Plan Personalizado',
    kindCustomDescription: 'Armá un cronograma a mano: sus items, fechas y montos los definís vos.',
    groupNamePlaceholder: 'ej. Viaje a Bariloche, Cumpleaños',
    groupMembersLabel: 'Eventos y Drafts a Agrupar',
    groupMembersCount_one: '{{count}} miembro seleccionado.',
    groupMembersCount_other: '{{count}} miembros seleccionados.',
    groupHint: 'Un grupo ocurre una sola vez: no tiene cadencia, ni monto total, ni cantidad de cuotas. Solo se le agregan los eventos que lo componen.',
    groupDateLabel: 'Fecha',
    selectEventsTitle: 'Seleccionar Eventos',
    selectDraftsTitle: 'Seleccionar Drafts',
    addGroupDraftItem: 'Agregar Draft',
    removeGroupMember: 'Quitar del grupo',
    noGroupMembers: 'Todavía no agregaste eventos ni drafts.',
    groupedEventsList: 'Eventos agrupados',
    groupedEventsCount_one: '{{count}} evento',
    groupedEventsCount_other: '{{count}} eventos',
    noGroupedEvents: 'Todavía no hay eventos agrupados.',
    addGroupItem: 'Agregar evento',
    groupItemNumber: 'Ítem #{{number}}',
    groupItemNumberLabel: 'Orden',
    groupItemNewTitle: 'Nuevo ítem del grupo',
    groupItemEditTitle: 'Editar ítem del grupo',
    itemsList: 'Cronograma de Cuotas e Ítems',
    viewDetailTitle: 'Detalles del Plan de Pago',
    viewDraft: 'Ver Borrador',
    viewEvent: 'Ver Evento',
    noItems: 'No hay ítems ni cuotas generados aún.',
    itemNumber: 'Cuota #{{number}}',
    expectedDate: 'Fecha Vencimiento',
  ...
  files: {
    ...
    fromLabel: 'De (Remitente)',
    fromPlaceholder: 'remitente@ejemplo.com',
    toLabel: 'Para (Destinatario)',
    toPlaceholder: 'destinatario@ejemplo.com (opcional)',
    dateLabel: 'Fecha y Hora',
    bodyLabel: 'Cuerpo del mensaje',
    bodyPlaceholder: 'Escribí o pegá el contenido del correo aquí...',
    submitCreateEmail: 'Guardar correo',
    preview: {
      title: 'Vista previa',
  ...
  settings: {
    ...
    currency: 'Moneda',
    currencyDesc: 'Moneda preseleccionada para montos nuevos. Cada evento conserva la moneda con la que fue registrado.',
  ...
  // ─── Data Transfer ─────────────────────────────────────────────────────────────
  dataTransfer: {
    modalTitle: 'Copia de Seguridad y Restauración',
    tabs: {
      export: 'Exportar Datos',
      import: 'Importar Datos',
    },
    totalRecords: 'Registros Preparados',
    exportDesc: 'Exporta las 12 secciones del sistema y todos los archivos adjuntos en un paquete ZIP encriptado.',
    downloadZip: 'Descargar Respaldo (.ZIP)',
    exporting: 'Exportando...',
    selectFile: 'Elegí o Arrastrá un Archivo de Respaldo (.ZIP)',
    fileHint: 'Soporta archivos .zip generados por My Pay By Day',
    readyToInspect: 'Archivo inspeccionado y verificado',
    analyzing: 'Inspeccionando registros del respaldo...',
    previewTitle: 'Vista Previa del Contenido del Respaldo',
    resultsSummaryTitle: 'Proceso de Importación Finalizado',
    itemsImported: 'registros restaurados con éxito',
    skippedCount: 'omitidos',
    itemsFound: 'registros encontrados',
    loadingSummary: 'Cargando manifiesto del respaldo...',
    startImport: 'Restaurar Respaldo Ahora',
    importing: 'Restaurando Datos...',
    skippedNotice: 'Algunos elementos fueron omitidos durante la importación:',
    groups: {
      core: 'Cuentas Principales y Taxonomías',
      activity: 'Transacciones, Planes y Borradores',
      system: 'Archivos y Configuración del Sistema',
    },
    sections: {
      DUPLICATE_DETECTION_SETTINGS: 'Configuración de Detección de Duplicados',
      TAGS: 'Etiquetas',
      CATEGORIES: 'Categorías',
      FINANCE_NODES: 'Cuentas y Contactos',
      FILES: 'Archivos y Adjuntos',
      TAG_GROUPS: 'Grupos de Etiquetas',
      SUBSCRIPTIONS: 'Suscripciones',
      TEMPLATES: 'Plantillas',
      TIME_PERIODS: 'Períodos de Presupuesto',
      EVENTS: 'Eventos Financieros',
      DRAFTS: 'Borradores',
      PAYMENT_PLANS: 'Planes de Pago',
    },
    sectionDescs: {
      DUPLICATE_DETECTION_SETTINGS: 'Reglas para detección de duplicados',
      TAGS: 'Todas las etiquetas y marcas',
      CATEGORIES: 'Categorías presupuestarias',
      FINANCE_NODES: 'Cuentas propias y entidades externas',
      FILES: 'Comprobantes y adjuntos subidos',
      TAG_GROUPS: 'Agrupaciones de etiquetas',
      SUBSCRIPTIONS: 'Suscripciones recurrentes',
      TEMPLATES: 'Plantillas de eventos',
      TIME_PERIODS: 'Períodos de tiempo presupuestados',
      EVENTS: 'Movimientos y eventos financieros',
      DRAFTS: 'Borradores incompletos',
      PAYMENT_PLANS: 'Planes en cuotas y recurrentes',
    },
    errors: {
      invalidFile: 'Formato de archivo zip de respaldo no válido',
    },
  },
  ...
  validation: {
    ...
    descriptionTooLong: 'La descripción debe tener como máximo 32000 caracteres',
    ...
    numberMinimum: 'Debe ser al menos 1',
