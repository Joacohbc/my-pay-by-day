...
const es = {
  ...
  dataTransfer: {
    ...
    exportTag: 'Respaldo Completo de Base de Datos',
    ...
    importDesc: 'Seleccioná un respaldo ZIP exportado anteriormente para restaurar todas tus etiquetas, categorías, cuentas, eventos y configuraciones.',
    ...
    manifestTitle: 'Secciones del Sistema Incluidas',
    ...
    importSuccessTitle: 'Importación Completada con Éxito',
