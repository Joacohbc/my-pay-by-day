...
const en = {
  ...
  dataTransfer: {
    ...
    exportTag: 'Complete Database Backup',
    ...
    importDesc: 'Select a previously exported ZIP backup to restore all tags, categories, nodes, events, and settings.',
    ...
    manifestTitle: 'Included Application Sections',
