...
const en = {
  ...
  chat: {
    ...
    approval: {
      ...
      installmentOf: 'Instalment {{number}} · {{date}}',
      ...
      pendingCount_one: '{{count}} approval pending',
      pendingCount_other: '{{count}} approvals pending',
      modes: {
        MERGE: 'Update the linked event',
        CREATE_ONLY: 'Create a new event',
      },
      tools: {
        updateEvent: 'Update this event',
        createEventGroup: 'Create the group “{{name}}”',
        createInstallmentPlan: 'Create the instalment plan “{{name}}”',
      ...
      fields: {
        ...
        installmentNumber: 'Instalment number',
      },
    },
    error: {
      title: 'The assistant could not finish this response',
      retry: 'Retry',
    },
    question: {
      title: 'Question',
  ...
  events: {
    ...
    mergeMixedCurrencies: 'These events are not in the same currency. Merging them would produce amounts that cannot balance, so the server will reject it.',
  ...
  nodes: {
    ...
    currencyHint: 'Set this for accounts you own, so an amount in another currency cannot be recorded against them by mistake. Leave it empty for shops and people, which can charge in any currency.',
  ...
  paymentPlans: {
    ...
    groupDateLabel: 'Date',
    selectEventsTitle: 'Select Events',
    selectDraftsTitle: 'Select Drafts',
    addGroupDraftItem: 'Add Draft',
    removeGroupMember: 'Remove from group',
    noGroupMembers: 'No events or drafts added yet.',
  ...
  files: {
    ...
    fromLabel: 'From (Sender)',
    fromPlaceholder: 'sender@example.com',
    toLabel: 'To (Recipient)',
    toPlaceholder: 'recipient@example.com (optional)',
    dateLabel: 'Date & Time',
    bodyLabel: 'Message body',
    bodyPlaceholder: 'Type or paste email content here...',
    submitCreateEmail: 'Save email',
    preview: {
      title: 'Preview',
  ...
  settings: {
    ...
    currency: 'Currency',
    currencyDesc: 'Currency preselected for new amounts. Each event keeps the currency it was recorded in.',
    timezone: 'Timezone',
