...
const en = {
  ...
  paymentPlans: {
    ...
    generateItems: 'Generate the cuotas schedule now',
    generateItemsHint: 'Turn this off to add each cuota manually later.',
    addItem: 'Add Cuota',
    ...
    kindInstallmentTitle: 'Cuotas & Subscriptions',
    kindInstallmentDescription: 'An installment purchase or a recurring subscription, with a cadence and an amount.',
    ...
    scheduleLockedHint: 'The schedule of this plan is generated by the system. You can only link an event or a draft and change the status.',
