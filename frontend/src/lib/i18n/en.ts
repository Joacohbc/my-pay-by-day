...
const en = {
  ...
  nodes: {
    ...
    iconLabel: 'Icon',
    profileSection: 'Limit and cycle',
    profileHint: 'Optional. A node with both a limit and a cycle behaves like a credit card; each one also works on its own.',
    limitLabel: 'Limit amount',
    limitPlaceholder: 'Leave empty for no limit',
    limitKindLabel: 'What the limit means',
    limitKindDebt: 'Debt cap — how far the balance may fall',
    limitKindTarget: 'Balance target — how high the balance should climb',
    cycleDayLabel: 'Closing day',
    settlementDayLabel: 'Settlement day',
    cycleDayHint: 'Day of the month, 1 to 28. Set both or neither.',
    remainingAvailable: 'Available',
    remainingToTarget: 'Left to target',
    limitExceeded: 'Over limit',
    closedCycleBalance: 'Closed cycle',
    openCycleBalance: 'Open cycle',
