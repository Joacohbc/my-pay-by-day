...
export const eventsService = {
  ...
  addRelation: (id: number, relatedId: number) =>
    api.post<FinanceEvent>(`/events/${id}/related/${relatedId}`, {}),
  removeRelation: (id: number, relatedId: number) =>
    api.delete(`/events/${id}/related/${relatedId}`),
};
